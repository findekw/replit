...
export const authApi = {
  ...
  office: {
    register: (body: { name: string; email: string; phone: string; password: string; slug?: string; officeDescription?: string; licenseNumber?: string; commercialReg?: string; governorateId?: number }) =>
