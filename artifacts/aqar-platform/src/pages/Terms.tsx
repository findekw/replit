...
const SECTIONS = [
  ...
  },
  {
    ...
    content:
      "تتوفر تجربة مجانية لمدة 7 أيام عند الموافقة على طلب التسجيل. بعد انتهاء التجربة، يلزم الاشتراك في إحدى الباقات المتاحة لمواصلة نشر الإعلانات. المدفوعات غير قابلة للاسترداد إلا في حالات استثنائية يقدرها فريق المنصة.",
  },
  {
