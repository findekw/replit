...
import {
  Building, Eye, Star, Phone, TrendingUp,
          ...
          return (
            <div className="bg-card border rounded-2xl p-5 mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4">
                ...
                <Tile label="المدة المتبقية" value={daysLeft !== null ? (daysLeft === 0 ? "منتهية" : `${daysLeft} ${daysLeft === 1 ? "يوم" : "أيام"}`) : "—"} color={daysLeft !== null && daysLeft <= 2 ? "#ea580c" : undefined} />
              </div>
