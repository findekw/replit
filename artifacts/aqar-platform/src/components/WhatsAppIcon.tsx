// WhatsApp glyph as an inline SVG (no extra dependency — matches the existing
// inline-SVG pattern used for KuwaitFlag). Uses currentColor by default so it
// inherits the parent's color; pass `color` to override (e.g. brand #25D366).
